...
SELECT ProductSubcategoryID, COUNT(*) AS Num
FROM Production.Product
...
SELECT c.ContactName, SUM(ISNULL(od.Quantity, 0)) AS CountOfProducts
...
SELECT o.CustomerID, SUM(od.Quantity) AS CountOfProducts
FROM Orders o LEFT JOIN [Order Details] od ON o.OrderID = od.OrderID
